...
# Creating an address for node in port 5000
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Irina', amount=1)
...
# Getting the complete blockchain
...
def is_valid():
    if blockchain.is_chain_valid(blockchain.chain):
        return jsonify({'message': 'Yeiiii!! Blockchain is valid!'}), 200
    else:
